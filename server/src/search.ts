import type { RecommendationKind, TaskRecommendation, TaskRecommendationResponse } from "./types.js";

const SEARCH_ENDPOINT = "https://html.duckduckgo.com/html/";

function inferKind(url: string): RecommendationKind {
...
function parseDuckDuckGoResults(html: string): Array<Pick<TaskRecommendation, "title" | "url" | "kind">> {
  const results: Array<Pick<TaskRecommendation, "title" | "url" | "kind">> = [];

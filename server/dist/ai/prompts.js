export function buildStudyPlanMessages(goal, contextForAI) {
    const systemPrompt = [
...
export function buildWorkflowLiveSnapshot(input) {
    return {
...
export function buildWorkflowAssistantMessages(input, liveSnapshot) {
    const systemPrompt = [
